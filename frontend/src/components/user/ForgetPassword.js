                ...
                <div className={`containe ${isSignUp ? 'active' : ''}`}>
                    <div className="form-container sign-up">
                        <form onSubmit={handleSubmit}>
                            ...
                            {(pass == pass2 && password === password2) ? <Link to="/" onClick={() => { (password === password2) ? setforgetpassword() : toast.error("Password must be same...") }}><button>Reset</button></Link> : <button onClick={() => { (password == "") ? setpass("enter new password") : setpass2("enter verify password") }} style={{ background: "#6fa781" }}>Reset</button>}
                        </form>
                    </div>
                    <div className="form-container sign-in">
                        <form onSubmit={handleSubmit}>
                            ...
                            {(input == email2) ? <button onClick={forgetpassword}>Submmit</button> : <button onClick={() => { (username == "") ? setinput("username is required") : (email == "") ? setemail2("email is required") : setemail2(" ") }} style={{ background: "#6fa781" }}>Submmit</button>}
                        </form>
                    </div>
