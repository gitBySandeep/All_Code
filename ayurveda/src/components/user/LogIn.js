                ...
                <div className={`container ${isSignUp ? 'active' : ''}`}>
                    <div className="form-container sign-up">
                        <form onSubmit={handleSubmit}>
                            ...
                            {(input2 == pass2 && pass2 == email2) ? <button onClick={signUp}>Sign Up</button> : <button onClick={() => { (username == "") ? setinput2("username is required") : (email == "") ? setemail2("email is required") : (password == "") ? setpass2("password is required") : setpass2(" ") }} style={{ background: "#6fa781" }}>Sign Up</button>}
                        </form>
                    </div>
                    <div className="form-container sign-in">
                        <form onSubmit={handleSubmit}>
                            ...
                            {(input == pass) ? <button onClick={signIn}>Sign In</button> : <button onClick={() => { (username == "") ? setinput("username is required") : (password == "") ? setpass("password is required") : setpass(" ") }} style={{ background: "#6fa781" }}>Sign In</button>}
                        </form>
                    </div>
